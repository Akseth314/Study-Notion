...
exports.capturePayment = async (req,res) => {
    ...
    try{
        ...
        if(!course){
            return res.json({
                success:false,
                message:'Could not find the course Id',
            });
        }
    ...
    try{
        // initiate the peyment using razorpay 
...
exports.verifySignature = async (req,res) => {
    ...
    if(signature === digest){
        ...
        try{
            ...
            // find the student and add the course to thier list enrolled courses mai
