        ...
        <div>
            ...
            <div className='relative mx-auto flex flex-col w-11/12 max-w-maxContent items-center text-white justify-between gap-8'>
                ...
                <div className="-mt-3 w-[90%] text-center text-lg font-bold text-richblack-300">
                    <p> With our online coding courses, you can learn at your own pace, from
                ...
                <div>
                    ...
                    backGroundGradient={"shadow-blue-700 shadow-[10px_-5px_50px_-5px]"}
                    />
                </div>
                {/* code section-2  */}
                <div>
                    ...
                    // backgroundGradient={<div className="shadow-blue-50 shadow-[10px_-5px_50px_-5px]"></div>}
                    backGroundGradient={"shadow-blue-700 shadow-[10px_-5px_50px_-5px] "}
                    />
                </div>
